...
public class ProducingAndConsumingASignedJWT {

	public static void main(String[] args) throws JoseException {
		ProducingAndConsumingASignedJWT p = new ProducingAndConsumingASignedJWT();
		p.jwt();
	...
	public void jwt() throws JoseException {
	    ...
	    try
	    {
	        ...
	        List<String> groupsReceived = jwtClaims.getStringListClaimValue("groups");
